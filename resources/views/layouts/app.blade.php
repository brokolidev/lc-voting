            ...
            <div class="w-70 md:mr-5 md:mx-0 mx-auto">
                ...
                >
                    ...
                    <form action="#" method="POST" class="space-y-4 px-4 py-6">
                        <div>
                            <input type="text" class="border-none text-sm w-full bg-gray-100 rounded-xl placeholder-gray-900 px-4 py-2" placeholder="Your Idea">
                        </div>
                        
                        <div>
                            <select name="category_add" id="category_add" class="w-full rounded-xl px-4 py-2 border-none bg-gray-100 text-sm">
