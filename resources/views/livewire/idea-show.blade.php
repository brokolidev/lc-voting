<div class="idea-and-buttons container">
            ...
            <div class="mx-2 md:mx-4 w-full mt-2 md:mt-0">
                ...
                <div class="flex md:items-center justify-between mt-6 flex-col md:flex-row">
                    ...
                    <div class="mt-4 md:mt-0 md:hidden flex items-center">
                        ...
                        @if ($hasVoted)
                            <button class="w-20 bg-blue border text-white border-blue font-bold text-xxs uppercase rounded-xl hover:bg-blue-hover transition duration-150 ease-in px-4 py-3 -mx-5">Voted</button>
                        @else
    ...
    <div class="buttons-conatiner flex items-center justify-between mt-6">
        ...
        <div class="md:flex items-center space-x-3 hidden">
            ...
            @if ($hasVoted)
                <button type="button" class="h-11 w-32 uppercase text-xs bg-blue text-white font-semibold rounded-xl border border-blue hover:bg-blue-hover transition duration-150 ease-in px-6 py-3">
                    <span>Voted</span>
                </button>
            @else
