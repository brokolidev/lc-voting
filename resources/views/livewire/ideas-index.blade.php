<div>
    <div class="filters flex flex-col md:flex-row md:space-x-6 md:space-y-0 space-y-3">
        ...
        <div class="w-full md:w-2/3 relative">
            <input wire:model.debounce.1000ms="search" type="search" placeholder="Find an idea" class="w-full rounded-xl bg-white px-4 py-2 pl-8 border-none placeholder-gray-900">
