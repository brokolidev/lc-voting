<form 
    ...
    <div>
        <input wire:model.defer="title" type="text" class="border-none text-sm w-full bg-gray-100 rounded-xl placeholder-gray-900 px-4 py-2" placeholder="Your Idea" required>
        @error('title')
