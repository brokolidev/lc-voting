<div x-data="{ isOpen: false }">
    ...
    isOpen = false
})" x-cloak x-show="isOpen" x-transition:enter="transition ease-out duration-150"
        ...
        <div class="flex items-center">
            ...
            <div class="ml-2 font-semibold text-gray-500 sm:text-base text-sm">Idea was updated successfully!</div>
        </div>
